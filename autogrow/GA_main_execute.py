...
import autogrow.operators.operations_my as operations
import autogrow.docking.concatenate_files as concatenate_files

def main_execute(vars):
    """
    This function takes the user variables and runs GA
