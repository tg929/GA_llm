...
PARSER.add_argument(
    ...
    "-s",
    type=str,
    default='./datasets/source_compounds/naphthalene_smiles.smi',
...
PARSER.add_argument(
    ...
    metavar="mgl_python",
    required=False,
    help="/data1/ytg/RGA/mgltools_x86_64Linux2_1.5.6/",
)
PARSER.add_argument(
    "--prepare_ligand4.py",
...
file = './datasets/source_compounds/naphthalene_smiles.smi'
