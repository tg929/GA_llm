...
PARSER.add_argument("--output_file", "-o",type=str, default="/data1/ytg/GA_llm/output/generation_crossover_0.smi")
...
def main():
    ...
    with open("/data1/ytg/GA_llm/output/generation_0_crossed_new.smi", 'w') as f:
