...
def main():    
    ...
    try:
        ...
        vars = {
            ...
            'rxn_library_file': '/data1/tgy/GA_llm/autogrow/operators/mutation/smiles_click_chem/reaction_libraries/click_chem_rxns/ClickChem_rxn_library.json',
            'function_group_library': '/data1/tgy/GA_llm/autogrow/operators/mutation/smiles_click_chem/reaction_libraries/click_chem_rxns/ClickChem_functional_groups.json',
            'complementary_mol_directory':'/data1/tgy/GA_llm/autogrow/operators/mutation/smiles_click_chem/reaction_libraries/click_chem_rxns/complementary_mol_dir',
            'filter_object_dict': {
                'Lipinski_Strict': LipinskiStrictFilter()
            },
                    ...
                    try:
                        ...
                        for smi in result:
                            try:
                                ...
                                if mol is not None and all([filter_obj.run_filter(mol) for filter_obj in vars['filter_object_dict'].values()]):
