...
def main():
    ...
    parser.add_argument('--center_x', type=float, default=25.0, help='对接靶点X坐标')
    parser.add_argument('--center_y', type=float, default=16.0, help='对接靶点Y坐标')
    parser.add_argument('--center_z', type=float, default=25.0, help='对接靶点Z坐标')
    parser.add_argument('--size_x', type=float, default=-70.76, help='对接盒子X大小')
    parser.add_argument('--size_y', type=float, default=21.82, help='对接盒子Y大小')
    parser.add_argument('--size_z', type=float, default=28.33, help='对接盒子Z大小')
